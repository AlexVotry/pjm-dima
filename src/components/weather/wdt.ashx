...
public class proxy : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context) {
        ...
        try {
            ...
            // check if we're hitting wdt, and add in the username and password from the web.config if so
            if (serverUrl.Url.StartsWith("https://gisweb.wdtinc.com"))
            {
                serverUrl.Username = "pjm_gis";
                serverUrl.Password = "wdtWXd@t@";
            }
        }
        ...
        if (serverResponse != null) {
            using (Stream byteStream = serverResponse.GetResponseStream()) {
                ...
                if (serverResponse.ContentType.Contains("text") ||
                    ...
                    clientResponse.CacheControl = "public";
                    clientResponse.Expires = 180;
